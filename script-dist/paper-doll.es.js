var Y, o, VC, R, GA, JC, XA, XC, M = {}, PC = [], vI = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, oA = Array.isArray;
function Z(C, A) {
  for (var I in A)
    C[I] = A[I];
  return C;
...
function nA() {
  ...
  for (R.sort(XA); C = R.shift(); )
    C.__d && (A = R.length, g = void 0, t = (e = (I = C).__v).__e, r = [], n = [], (E = I.__P) && ((g = Z({}, e)).__v = e.__v + 1, o.vnode && o.vnode(g), qA(E, g, e, I.__n, E.ownerSVGElement !== void 0, 32 & e.__u ? [t] : null, r, t ?? L(e), !!(32 & e.__u), n), g.__.__k[g.__i] = g, wC(r, g, n), g.__e != t && ZC(g)), R.length > A && R.sort(XA));
  nA.__r = 0;
}
function OC(C, A, I, g, e, t, E, r, n, i, s) {
  var Q, a, B, f, l, c = g && g.__k || PC, d = A.length;
  for (I.__d = n, pI(I, A, c), n = I.__d, Q = 0; Q < d; Q++)
...
function pI(C, A, I) {
  ...
  for (C.__k = [], g = 0; g < n; g++)
    (e = C.__k[g] = (e = A[g]) == null || typeof e == "boolean" || typeof e == "function" ? null : typeof e == "string" || typeof e == "number" || typeof e == "bigint" || e.constructor == String ? U(null, e, null, null, e) : oA(e) ? U(z, { children: e }, null, null, null) : e.__b > 0 ? U(e.type, e.props, e.key, e.ref ? e.ref : null, e.__v) : e) != null ? (e.__ = C, e.__b = C.__b + 1, r = hI(e, I, E = g + Q, s), e.__i = r, t = null, r !== -1 && (s--, (t = I[r]) && (t.__u |= 131072)), t == null || t.__v === null ? (r == -1 && Q--, typeof e.type != "function" && (e.__u |= 65536)) : r !== E && (r === E + 1 ? Q++ : r > E ? s > n - E ? Q += r - E : Q-- : Q = r < E && r == E - 1 ? r - E : 0, r !== g + Q && (e.__u |= 65536))) : (t = I[g]) && t.key == null && t.__e && (t.__e == C.__d && (C.__d = L(t)), WA(t, t, !1), I[g] = null, s--);
  if (s)
    for (g = 0; g < i; g++)
      (t = I[g]) != null && !(131072 & t.__u) && (t.__e == C.__d && (C.__d = L(t)), WA(t, t));
}
function zC(C, A, I) {
  var g, e;
...
function MA(C, A, I) {
  A[0] === "-" ? C.setProperty(A, I ?? "") : C[A] = I == null ? "" : typeof I != "number" || vI.test(A) ? I : I + "px";
}
...
function qA(C, A, I, g, e, t, E, r, n, i) {
  ...
  A:
    if (typeof y == "function")
      try {
        if (d = A.props, v = (s = y.contextType) && g[s.__c], m = s ? v ? v.props.value : s.__ : g, I.__c ? c = (Q = A.__c = I.__c).__ = Q.__E : ("prototype" in y && y.prototype.render ? A.__c = Q = new y(d, m) : (A.__c = Q = new W(d, m), Q.constructor = y, Q.render = mI), v && v.sub(Q), Q.props = d, Q.state || (Q.state = {}), Q.context = m, Q.__n = g, a = Q.__d = !0, Q.__h = [], Q._sb = []), Q.__s == null && (Q.__s = Q.state), y.getDerivedStateFromProps != null && (Q.__s == Q.state && (Q.__s = Z({}, Q.__s)), Z(Q.__s, y.getDerivedStateFromProps(d, Q.__s))), B = Q.props, f = Q.state, Q.__v = A, a)
      ...
      t == null && A.__v === I.__v ? (A.__k = I.__k, A.__e = I.__e) : A.__e = bI(I.__e, A, I, g, e, t, E, n, i);
  (s = o.diffed) && s(A);
}
function wC(C, A, I) {
  A.__d = void 0;
...
function bI(C, A, I, g, e, t, E, r, n) {
  ...
  if (v === null)
    ...
    else if (Q && (C.innerHTML = ""), OC(C, oA(a) ? a : [a], A, I, g, e && v !== "foreignObject", t, E, t ? t[0] : I.__k && L(I, 0), r, n), t != null)
      for (i = t.length; i--; )
        t[i] != null && WC(t[i]);
...
class PI {
  enter(A) {
    ...
    return this.entered = XI(this.entered.filter(g), [
      A
    ]), I === 0 && this.entered.length > 0;
  }
  leave(A) {
    const I = this.entered.length;
    return this.entered = JI(this.entered.filter(this.isNodeInDocument), A), I > 0 && this.entered.length === 0;
  }
  reset() {
    this.entered = [];
  }
...
const zI = 1;
function LC(C) {
  const A = C.nodeType === zI ? C : C.parentElement;
  if (!A)
    return null;
...
function wI(C) {
  var A;
  return C.nodeName === "IMG" && (OI() || !(!((A = document.documentElement) === null || A === void 0) && A.contains(C)));
}
function SI(C, A, I, g) {
...
function RI(C, A, I, g, e) {
  const t = wI(A), r = LC(t ? C : A), n = {
    x: I.x - r.x,
    y: I.y - r.y
  }, { offsetWidth: i, offsetHeight: s } = C, { anchorX: Q, anchorY: a } = g, { dragPreviewWidth: B, dragPreviewHeight: f } = SI(t, A, i, s), l = () => {
    let j = new $A([
      0,
      0.5,
      1
...
class TI {
  ...
  */
  ...
  beginDragNativeItem(A, I) {
    this.clearCurrentDragSourceNode(), this.currentNativeSource = ZI(A, I), this.currentNativeHandle = this.registry.addSource(A, this.currentNativeSource), this.actions.beginDrag([
  ...
  constructor(A, I, g) {
    this.sourcePreviewNodes = /* @__PURE__ */ new Map(), this.sourcePreviewNodeOptions = /* @__PURE__ */ new Map(), this.sourceNodes = /* @__PURE__ */ new Map(), this.sourceNodeOptions = /* @__PURE__ */ new Map(), this.dragStartSourceIds = null, this.dropTargetIds = [], this.dragEnterTargetIds = [], this.currentNativeSource = null, this.currentNativeHandle = null, this.currentDragSourceNode = null, this.altKeyPressed = !1, this.mouseMoveTimeoutTimer = null, this.asyncEndDragFrameId = null, this.dragOverTargetIds = null, this.lastClientOffset = null, this.hoverRafId = null, this.getSourceClientOffset = (e) => {
      ...
      if (this.monitor.isDragging()) {
        if (r && typeof r.setDragImage == "function") {
          ...
          if (a) {
            const { anchorX: B, anchorY: f, offsetX: l, offsetY: c } = this.getCurrentSourcePreviewNodeOptions(), m = RI(Q, a, E, {
              anchorX: B,
              anchorY: f
            }, {
              offsetX: l,
    ...
    }, this.options = new NI(I, g), this.actions = A.getActions(), this.monitor = A.getMonitor(), this.registry = A.getRegistry(), this.enterLeaveCounter = new PI(this.isNodeInDocument);
  }
}
const DI = function(A, I, g) {
  return new TI(A, I, g);
};
...
o.__b = function(C) {
  ...
  eC && eC(C);
  var A = C.__c;
  A && A.__H && (A.__H.__h.length && (HC.push(A) !== 1 && CC === o.requestAnimationFrame || ((CC = o.requestAnimationFrame) || UI)(xI)), A.__H.__.forEach(function(I) {
...
function FC(C, A, I) {
  ...
  }), C.__c.__H = null), (C = FI({}, C)).__c != null && (C.__c.__P === I && (C.__c.__P = A), C.__c = null), C.__k = C.__k && C.__k.map(function(g) {
    return FC(g, A, I);
  })), C;
}
function GC(C, A, I) {
...
var YC = typeof Symbol < "u" && Symbol.for && Symbol.for("react.element") || 60103, YI = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/, KI = /^on(Ani|Tra|Tou|BeforeInp|Compo)/, _I = /[A-Z0-9]/g, $I = typeof document < "u", Ag = function(C) {
...
o.event = function(C) {
  return sC && (C = sC(C)), C.persist = Cg, C.isPropagationStopped = Ig, C.isDefaultPrevented = gg, C.nativeEvent = C;
};
var eg = { enumerable: !1, configurable: !0, get: function() {
  return this.class;
} }, oC = o.vnode;
o.vnode = function(C) {
  typeof C.type == "string" && function(A) {
    ...
    for (var t in I) {
      var E = I[t];
      if (!(t === "value" && "defaultValue" in I && E == null || $I && t === "children" && g === "noscript" || t === "class" || t === "className")) {
        var r = t.toLowerCase();
        t === "defaultValue" && "value" in I && I.value == null ? t = "value" : t === "download" && E === !0 ? E = "" : r === "ondoubleclick" ? t = "ondblclick" : r !== "onchange" || g !== "input" && g !== "textarea" || Ag(I.type) ? r === "onfocus" ? t = "onfocusin" : r === "onblur" ? t = "onfocusout" : KI.test(t) ? t = r : g.indexOf("-") === -1 && YI.test(t) ? t = t.replace(_I, "-$&").toLowerCase() : E === null && (E = void 0) : r = t = "oninput", r === "oninput" && e[t = r] && (t = "oninputCapture"), e[t] = E;
      }
    }
    ...
    })), I.class && !I.className ? (e.class = I.class, Object.defineProperty(e, "className", eg)) : (I.className && !I.class || I.class && I.className) && (e.class = e.className = I.className), A.props = e;
...
function lC(C) {
  return KC(C) ? yI.apply(null, arguments) : C;
}
const _C = VI({
...
function p(C, A, I, g, e, t) {
  ...
  for (r in A)
    r == "ref" ? E = A[r] : n[r] = A[r];
  var i = { type: C, props: n, key: I, ref: E, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: --tg, __i: -1, __u: 0, __source: e, __self: t };
...
function T(C) {
  var A = typeof C;
  return process.env.NODE_ENV !== "production" && (A = rg(C)), A;
}
function $C(C, A, I) {
  var g;
...
const LA = "dnd-core/INIT_COORDS", uA = "dnd-core/BEGIN_DRAG", HA = "dnd-core/PUBLISH_DRAG_SOURCE", lA = "dnd-core/HOVER", dA = "dnd-core/DROP", cA = "dnd-core/END_DRAG";
function fC(C, A) {
  return {
    type: LA,
    payload: {
...
function mg(C) {
  return function(I = {}) {
    ...
    kg(g), Jg(g).forEach((E, r) => {
      const n = yg(E, r, e, g), i = {
        type: dA,
        payload: {
          dropResult: bg({}, I, n)
        }
...
function yg(C, A, I, g) {
  ...
  return Vg(t), typeof t > "u" && (t = A === 0 ? {} : g.getDropResult()), t;
}
function Vg(C) {
...
function Wg(C) {
  return function(I, { clientOffset: g } = {}) {
    ...
    return zg(e, E, r), Og(e, t, E), wg(e, t, E), {
      type: lA,
      payload: {
        targetIds: e,
        clientOffset: g || null
...
jA.__IS_ALL__ = !0;
function Lg(C, A) {
  return C === F ? !1 : C === jA || typeof A > "u" ? !0 : ug(A, C).length > 0;
}
class Hg {
...
class Ug {
  ...
  constructor() {
    ...
    }, this.requestFlush = xg(this.flush), this.requestErrorThrow = gI(() => {
...
class Gg {
  create(A) {
    const I = this.freeTasks, g = I.length ? I.pop() : new Fg(
      this.onError,
      (e) => I[I.length] = e
    );
    return g.task = A, g;
...
const eI = new Ug(), Mg = new Gg(eI.registerPendingError);
function Yg(C) {
  eI.enqueueTask(Mg.create(C));
}
...
class Ee {
  ...
  removeSource(A) {
    u(this.getSource(A), "Expected an existing source."), this.store.dispatch($g(A)), Yg(() => {
      this.dragSources.delete(A), this.types.delete(A);
    });
  }
  removeTarget(A) {
    u(this.getTarget(A), "Expected an existing target."), this.store.dispatch(Ae(A)), this.dropTargets.delete(A), this.types.delete(A);
  }
  pinSource(A) {
...
function ie(C = F, A) {
  ...
  const { targetIds: I = [], prevTargetIds: g = [] } = A.payload, e = ag(I, g);
  if (!(e.length > 0 || !ne(I, g)))
    return F;
...
function oe(C = bC, A) {
  ...
  switch (A.type) {
    ...
    case lA:
      return Qe(C.clientOffset, I.clientOffset) ? C : se({}, C, {
        clientOffset: I.clientOffset
      });
    case cA:
    case dA:
  ...
  switch (A.type) {
    ...
    case fA:
      return C.targetIds.indexOf(I.targetId) === -1 ? C : D({}, C, {
        targetIds: og(C.targetIds, I.targetId)
      });
    case dA:
      return D({}, C, {
...
function pe(C = {}, A) {
  return {
    dirtyHandlerIds: ie(C.dirtyHandlerIds, {
      type: A.type,
      payload: ve({}, A.payload, {
        prevTargetIds: sg(C, "dragOperation.targetIds", [])
      })
    }),
    dragOffset: oe(C.dragOffset, A),
    refCount: de(C.refCount, A),
    dragOperation: le(C.dragOperation, A),
    stateId: ce(C.stateId)
  };
}
function he(C, A = void 0, I = {}, g = !1) {
  const e = be(g), t = new Hg(e, new Ee(e)), E = new Ng(e, t), r = C(E, A, I);
...
var ye = /* @__PURE__ */ GI(function(A) {
  var { children: I } = A, g = me(A, [
    "children"
  ]);
  const [e, t] = Ve(g);
  return aA(() => {
...
function Ve(C) {
  ...
  const A = Je(C.backend, C.context, C.options, C.debugMode), I = !C.context;
  return [
    A,
    I
  ];
}
function Je(C, A = tI(), I, g) {
  const e = A;
  return e[EA] || (e[EA] = {
    dragDropManager: he(C, A, I, g)
  }), e[EA];
}
function tI() {
...
const Pe = /* @__PURE__ */ EI(Xe), q = typeof window < "u" ? LI : aA;
function We(C, A, I) {
  const [g, e] = jC(
    () => A(C)
  ), t = HI(() => {
...
function Ye(C, A) {
  ...
  const g = xe(), e = je(I.options, I.previewOptions);
  return Me(I, g, e), [
    rI(I.collect, g, e),
    Oe(e),
    ze(e)
...
function et(C, A) {
  const I = QI(C, A), g = $e(), e = _e(I.options);
  return gt(I, g, e), [
    rI(I.collect, g, e),
    Ke(e)
  ];
...
function Dt({
  ...
  const e = Rt(), t = Object.values(C).filter(Nt).map((n) => Wt[n]), [E, r] = et(() => ({
  ...
  return p("section", {
    ...
    children: [p("div", {
      ...
      children: [t.map((n) => p("img", {
        alt: n.id,
        className: rA("added-piece", Tt(n.type)),
        src: n.src
      }, n.id, !1, {
        fileName: S,
        lineNumber: 51,
...
const jt = {
  ...
  tops: {
    title: "Tops",
    items: [...Object.values(sI), ...Object.values(oI), ...Object.values(aI)]
  },
  pants: {
    title: "Pants",
